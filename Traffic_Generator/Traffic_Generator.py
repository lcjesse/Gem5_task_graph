...
PE_num = 20
config = []
with open('PE_4cycles_ddr.cfg', "r") as ProcessorConfig:
...
outputFileName = application_model_file.replace(".info", ".stp").replace("model/", "2021_04_15/Memory_Access_20_Memory_Type_DDR/")
