...
do
    ...
    do
        app_model_file=/home/wj/Study/gem5/my_benchmarks/Application/512_12288_512/Application_0${app_num}.stp
        out_filename=Application_0${app_num}_iters${ex_iter}
        ./build/NULL/gem5.debug \
        --outdir my_STATS/test_20200616/test_iters_512_12288_512/${out_filename} \
