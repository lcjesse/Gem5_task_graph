...
GEM5=/home/lichang/Gem5_ete/Gem5_task_graph
DATE=`date +%Y_%m_%d`
# OUT_FILE_DIR=${GEM5}/my_STATS/11_25/multi_app
OUT_FILE_DIR=${GEM5}/my_STATS/${DATE}/test_pe/spec
BENCHMARK_DIR=${GEM5}/my_benchmarks/2021_03_16
ARCHITECTURE_DIR=${GEM5}/my_benchmarks/2021_03_16
...
if [ "$1" = "run" ];then
                            ...
                            do
    {
            ...
            # ARCHITECTURE_FILE=${BENCHMARK_DIR}/reconfig_Heterogeneous_SoC_with_${TOPO}_Topology_${EVAL}.arch
            ARCHITECTURE_FILE=${BENCHMARK_DIR}/reconfig_Heterogeneous_SoC_with_${TOPO}_Topology_App_0${APP_NUM}_${EVAL}.arch
