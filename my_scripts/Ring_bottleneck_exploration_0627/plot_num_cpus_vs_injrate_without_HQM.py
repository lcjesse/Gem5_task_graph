...
# read result.txt
dir_path = "/home/wj/Study/gem5/my_STATS/Ring_bottleneck_exploration_0627/Uniform_different_num_cores_without_HQM_vs_different_inj_rate/"
...
inj_flits_received = {}
inj_average_hops = {}
for num_cpus in ['8', '16', '32', '64', '128']:
    inj_delay[num_cpus] = []
...
for k,v in performance.items():
    ...
    plt.savefig(k + '_vs_Injection_Rate_without_HQM.png')
    plt.show()
