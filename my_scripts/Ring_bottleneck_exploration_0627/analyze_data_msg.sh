...
outfile=${GEM5}/my_STATS/Ring_bottleneck_exploration_0627/Application_with_different_msg_size/results.txt
msg_size=(
    256_512_512
    256_1600_512
    256_5120_512
...
do
    ...
    do
        ...
        infile=${GEM5}/my_STATS/Ring_bottleneck_exploration_0627/Application_with_different_msg_size/${dirname}/stats.txt
