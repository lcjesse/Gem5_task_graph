...
OUT_FILE_DIR=${GEM5}/my_STATS/single_iters_check_0918_1
...
do
    ...
    do
    {
        ...
        --task-graph-file="./my_benchmarks/09_18_13/Application_0${i}.stp" \
        --execution-iteration=${j} \
        --routing-algorithm=2 \
        --vcs-per-vnet=2 \
        --link-width-bits=256 \
        --architecture-file="./my_benchmarks/CMP-0906/Heterogeneous_SoC_with_Ring_Topology.arch"  &> ${OUT_FILE_DIR}/${DIR_NAME}/log
        #--ruby-clock=2GHz
        #--sys-clock=2GHz
