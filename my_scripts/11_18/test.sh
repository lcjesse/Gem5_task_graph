...
do
            ...
            do
    {
        ...
        --task-graph-file="${GEM5}/my_benchmarks/11_18/Memory_Access_${MEM_ACCESS}_Memory_Type_${MEM_TYPE}/multi_application_0${APP_NUM}.cfg" \
        --execution-iteration=${ITERS}\
        --routing-algorithm=2 \
        --vcs-per-vnet=2 \
        --link-width-bits=256 \
        --architecture-file="${GEM5}/my_benchmarks/11_18/Heterogeneous_SoC_with_Ring_Topology.arch"
