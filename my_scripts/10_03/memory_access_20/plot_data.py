...
# read two result.txt
dir_path = "/home/wj/test/Gem5_task_graph/my_STATS/test_0930/memory_access_20/"
...
for app_num in range(1,6):
    ...
    for iter in iters:
        filename = "Application_0" + str(app_num) + "_Iters_" + iter
...
plt.savefig(fig_path + 'Average_ETE_Delay_vs_Iters.jpg')
...
plt.title("Flits Received vs. Execution Iterations")
plt.xlabel("Execution Iterations", fontsize=12)
plt.ylabel("Average Flits Received", fontsize=12)
plt.legend(plt_ptrs, legend_list)
ax = plt.gca()
ax.set_xticks([0,1,2,3,4,5])
ax.set_xticklabels(iters)
plt.tight_layout()
plt.savefig(fig_path + 'Flits_vs_Iters.jpg')
...
plt.title("Average Flit Hops vs. Execution Iterations")
plt.xlabel("Execution Iterations", fontsize=12)
...
ax.set_xticklabels(iters)
plt.tight_layout()
plt.savefig(fig_path + 'Hops_vs_Iters.jpg')
...
plt.title("Average Flit Latency vs. Execution Iterations")
plt.xlabel("Execution Iterations", fontsize=12)
...
ax.set_xticklabels(iters)
plt.tight_layout()
plt.savefig(fig_path + 'Latency_vs_Iters.jpg')
...
plt.title("Average Flit Network Latency vs. Execution Iterations")
plt.xlabel("Execution Iterations", fontsize=12)
...
ax.set_xticklabels(iters)
plt.tight_layout()
plt.savefig(fig_path + 'Network_Latency_vs_Iters.jpg')
...
plt.title("Average Flit Queueing Latency vs. Execution Iterations")
plt.xlabel("Execution Iterations", fontsize=12)
...
ax.set_xticklabels(iters)
plt.tight_layout()
plt.savefig(fig_path + 'Queueing_Latency_vs_Iters.jpg')
...
for app_num in range(1,6):
    ...
    plt.cla()       #clear plt
    for iter in iters:
        legend_list.append("iter_" + iter)
        link_file_path = link_result_path + "link_record_App_0" + str(app_num) + "_iters_" + iter + ".txt"
