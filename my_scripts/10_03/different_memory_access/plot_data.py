...
# read two result.txt
dir_path = "/home/wj/test/Gem5_task_graph/my_STATS/test_0930/different_memory_access/"
...
########### Five parameters_vs_Memory_Access ##########
# five apps with different Memory Access
...
for app_num in range(1,6):
    ...
    for mc in mem_access:
        filename = "Application_0" + str(app_num) + "_Memory_Access_" + mc
...
plt.title("Average ETE Delay vs. Memory Access")
plt.xlabel("Memory Access", fontsize=12)
plt.ylabel("Average ETE Delay", fontsize=12)
plt.legend(plt_ptrs, legend_list)
ax = plt.gca()
ax.set_xticks([0,1,2,3,4])
ax.set_xticklabels(mem_access)
plt.tight_layout()      # avoid incomplete display
plt.savefig(fig_path + 'Average_ETE_Delay_vs_Memory_Access.jpg')
...
plt.title("Flits Received vs. Memory Access")
plt.xlabel("Memory Access", fontsize=12)
...
ax.set_xticks([0,1,2,3,4])
ax.set_xticklabels(mem_access)
plt.savefig(fig_path + 'Flits_vs_Memory_Access.jpg')
...
plt.title("Average Flit Hops vs. Memory Access")
plt.xlabel("Memory Access", fontsize=12)
...
ax.set_xticklabels(mem_access)
plt.tight_layout()
plt.savefig(fig_path + 'Hops_vs_Memory_Access.jpg')
...
plt.title("Average Flit Latency vs. Memory Access")
plt.xlabel("Memory Access", fontsize=12)
...
ax.set_xticklabels(mem_access)
plt.tight_layout()
plt.savefig(fig_path + 'Latency_vs_Memory_Access.jpg')
...
plt.title("Average Flit Network Latency vs. Memory Access")
plt.xlabel("Memory Access", fontsize=12)
...
ax.set_xticklabels(mem_access)
plt.tight_layout()
plt.savefig(fig_path + 'Network_Latency_vs_Memory_Access.jpg')
...
plt.title("Average Flit Queueing Latency vs. Memory Access")
plt.xlabel("Memory Access", fontsize=12)
...
ax.set_xticklabels(mem_access)
plt.tight_layout()
plt.savefig(fig_path + 'Queueing_Latency_vs_Memory_Access.jpg')
...
for app_num in range(1,6):
    ...
    plt.cla()       #clear plt
    for mc in mem_access:
        legend_list.append("mem_access_" + mc)
        link_file_path = link_result_path + "link_record_App_0" + str(app_num) + "_Memory_Access_" + mc + ".txt"
...
for i in range(1, len(ete_data)):
    ...
    plt_ptrs.append(plt_ptr)
plt.title("ETE Delay vs. Execution Iterations")
...
for app_num in range(1,6):
    ...
    plt.cla()       #clear plt
    for mc in mem_access:
        legend_list.append("memory_access_" + mc)
        link_file_path =link_result_path + "link_record_App_0" + str(app_num) + "_Memory_Access_" + mc + ".txt"
        with open(link_file_path) as input_file:
            input_data = input_file.readlines()
...
# plt.title("Average ETE Delay vs. Execution Iterations")
# plt.xlabel("Execution Iterations", fontsize=12)
# plt.ylabel("ETE Delay", fontsize=12)
# plt.legend(plt_ptrs, legend_list)
# ax = plt.gca()
